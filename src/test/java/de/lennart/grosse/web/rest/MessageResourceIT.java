...
import de.lennart.grosse.repository.MessageRepository;
...
public class MessageResourceIT {
    ...
    private static final LocalDate DEFAULT_TIME_SEND = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_TIME_SEND = LocalDate.now(ZoneId.systemDefault());
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getTimeSend()).isEqualTo(DEFAULT_TIME_SEND);
    }
    ...
    public void getAllMessages() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].timeSend").value(hasItem(DEFAULT_TIME_SEND.toString())));
    }
    ...
    public void getMessage() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages/{id}", message.getId()))
            ...
            .andExpect(jsonPath("$.timeSend").value(DEFAULT_TIME_SEND.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateMessage() throws Exception {
        ...
        assertThat(testMessage.getTimeSend()).isEqualTo(UPDATED_TIME_SEND);
    }
