package de.lennart.grosse.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.lennart.grosse.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.lennart.grosse.repository.UserRepository.USERS_BY_EMAIL_CACHE);
